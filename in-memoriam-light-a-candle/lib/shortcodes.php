	...
	if ( isset( $_POST['candle-postback'] ) && wp_verify_nonce( $_POST['candle_nonce'], 'add-candle' ) ):
        ...
        <form id="add-candle" enctype="multipart/form-data" name="add-candle" method="POST" action="<?php the_permalink(); ?>">
			...
			<?php if ( 1 == get_option( 'imlac_candle_publish_notification' ) ) : ?>
                <label for="candle_title_email"><?php _e( 'Email to notify of your prayer (optional):', 'in-memoriam-light-a-candle' ); ?> </label>
                <br/><input type="text" maxlength="65" size="65" name="candle_title_email" id="candle_title_email"/>
                <br/><br/>
			<?php endif; ?>
			...
			<?php if ( 1 == get_option( 'imlac_candle_publish_notification' ) ) : ?>
                <label for="candle_prayer_email"><?php _e( 'Your Email (optional):', 'in-memoriam-light-a-candle' ); ?></label>
                <br/><input type="text" maxlength="65" size="65" name="candle_prayer_email" id="candle_prayer_email"/>
                <br/><br/>
			<?php endif; ?>

            <?php do_action('candle_extra_fields'); ?>
